...
<style> 
.book_out span {
	background-color: #740b03 !important;
...
background: rgb(110, 175, 191) !important;
border: 1px solid rgb(85, 131, 143) !important;
box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0.1) inset !important;
color: rgb(224, 224, 224) !important;
margin: -1px !important;
position: relative !important;
text-shadow: 0 1px 0 rgb(77, 122, 133) !important;
}*/
...
jQuery(document).ready(function()
{
	...
	jQuery('[name=yes_im]').click(function()
	{
		if(jQuery(this).is(':checked'))
		{
			...
			jQuery('.accept').empty().append(loader);
			jQuery.ajax({  
				type: "POST",
				url:"<?php bloginfo('template_url'); ?>/ajax/user_accept_challenge.php",
				data:{post_id:post_id,user_id:user_id,format:'raw'},
				success:function(resp){ 
					if( resp !="")
					{
						if(resp==1)
						{
							window.location.href="<?php echo site_url(); ?>/forum/";
						}	
					}
...
<input type="text" id="curr_user_id" value="<?php echo $user_id; ?>" />
       ...
       <div class="col-xs-12 col-md-3">
         <div class="progreess-section">
           ...
           <div class="current-challenge">
			 ...
			 if($rowCount > 0)
			 {
				 $arr=createDateRange($start_date, $end_date);
				 if (in_array($today, $arr)) 
				 {
				 ?>
				 <span><?php echo $post_title; ?></span></h3>
				 <h3>Group Start Date:<span><?php echo date('d/m/Y', strtotime($start_date)); ?></span></h3>
				 <?php
				 }
				 else
				 {
				 ?>
				 <div class="alert alert-danger">No challenge activated</div>
				 <?php	
				 }		
			 }
			 else
				 ...
				 <div class="forum-box">	 
					 ...
					 <div class="coments-views">
					   <div class="comments-counter">
						 <a href=""><i class="fa fa-thumbs-up" aria-hidden="true"></i>Mary jane and 2 other </a>
					   </div> 
