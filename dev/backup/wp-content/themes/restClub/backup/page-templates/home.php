  ...
  <div class="chat-blog">
    <div class="col-md-6">
      <div class="chat-box-wrap">
        <div class="pp"> <img src="<?php echo get_template_directory_uri(); ?>/images/sd.jpg" alt="..." /> </div>
        <div class="content-box">
          <p>Lorem Ipsum is simply dummy text of the printing and <strong>typesetting</strong> industry. Lorem Ipsum has been the industry's standard dummy</p>
          <ul>
