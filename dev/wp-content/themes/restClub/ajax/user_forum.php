...
$is_like=get_like_dislike($post_id,$curr_user_id); ?>
<ul>
   <?php
   ...
   {	   
   ?>
   <li class="like_<?php echo $post_id; ?>"><a href="javascript:void(0);"  onclick="like_dislike('1','<?php echo $post_id; ?>','<?php echo $curr_user_id; ?>');"> <i class="fa fa-thumbs-up" aria-hidden="true"></i>Like</a></li> 
   <?php
   }
   else
   {	   
   ?>
   <li class="like_<?php echo $post_id; ?>"><a href="javascript:void(0);" class="active" onclick="like_dislike('0','<?php echo $post_id; ?>','<?php echo $curr_user_id; ?>');"> <i class="fa fa-thumbs-up" aria-hidden="true"></i>Like</a></li>  
   <?php 
   }
   ?>
...
<div class="comments-counter comments_counter_<?php echo $post_id; ?>"></div>
